...
(function () {
    (function (a, b) {
        ...
        if (!b) {
            b = !!navigator
                .userAgent
                .match(/MSIE 10\.|Trident.*rv[ :]*1[01]\.| Edge\/1\d\./)
        }
        function a(i, k, g, h) {
    ...
    (function (a, b) {
        ...
        function c(e) {
            ...
            if (q || (!i.force && !d && !n && !x && !m && (!i.hacks || !i.hacks.required(i)))) {
                if (window.console && q) {
                    console.info("viewport-units-buggyfill requires a proper CSSOM and basic viewport unit support" +
                            ", which are not available in IE8 and below")
                }
        ...
        function t(J) {
            ...
            if (!J.style) {
                ...
                z
                    .call(J.cssRules, function (e) {
                        t(e)
                    });
                return
            }
            z
                .call(J.style, function (e) {
                    var K = J
                        .style
                        .getPropertyValue(e);
